...
public class Move {
    ...
    private static final String nullPieces = "¬ы не можете играть с нулевой доской.";
    private static final String nullCoord = " оординаты доски не должны быть нулевыми.";
